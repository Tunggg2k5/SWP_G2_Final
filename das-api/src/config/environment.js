...
export const env = {
  ...
  SMTP_USER: process.env.SMTP_USER || "kieutrunghieu104@gmail.com",
  SMTP_PASS: process.env.SMTP_PASS || "fvvuooihubaxtvjw",
  SMTP_FROM: process.env.SMTP_FROM || "\"SmileCare <kieutrunghieu104@gmail.com>\"",
